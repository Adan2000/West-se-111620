...
ActiveRecord::Schema.define(version: 2020_12_21_183137) do
  ...
  add_foreign_key "allergies", "ingredients", on_delete: :cascade
  add_foreign_key "allergies", "users", on_delete: :cascade
