...
function buildTrainerCard(trainer){
    ...
    // div['data-id'] = trainer.id.toString()
    // console.log(div)
...
function buildPokemonLi(pokemon, ul){
    ...
    // btn.addEventListener('click',releasePokemon2)
...
// function releasePokemon2(e){
//     let pok = document.querySelector(`[data-pokemon-id='${e.target.dataset.pokemonId}']`)
