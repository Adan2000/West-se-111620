...
## Use `json-server` to Provide a Basic RESTful Data Store [x]
...
* [x] Populate page with quotes with a `GET` request to
...
* [x] Each quote should have the following structure:
...
* [x] Submitting the form creates a new quote and adds it to the list of quotes
  without having to refresh the page. Pessimistic rendering is recommended.

* [x] Clicking the delete button should delete the respective quote from the
